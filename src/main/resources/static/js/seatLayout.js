...
(function ($) {
    function Movieseat(_paramObject) {
        ...
        var getMainLayoutFunc = function (_obj) {
            ...
            var actionPanel = pluginOptions.showActionButtons?"<div class='seat-proccess-panel'><button type='button' class='layout-action-btn layout-btn-done "+ pluginOptions.classes.doneBtn +"'> Done </button> </div>":"";
    ...
    $.fn.seatLayout = function (_options) {
        ...
        var selectedSeats = [];
        var numberOfSeat = _optionsObj.numberOfSeat;
        var tempSelected = 0;
        var _el = this;
        var _html = "";
        ...
        _el.find('li').click(function (e) {
            if ($(this).hasClass('can-select')) {
                ...
                tempSelected = count;
                _el.find('.layout-btn-done').prop('disabled', !(numberOfSeat == selectedSeats.length));
        ...
        _el.find('.layout-btn-done').click(function (e) {
            if (_optionsObj.selectionDone) {
                _optionsObj.selectionDone({selectedSeats});
            }
        });
        return this;
    };
